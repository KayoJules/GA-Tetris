...
class Settings:
    def __init__(self):
        ...
        self.time_stop = 0.1 # time player can adjust pos at bottom | Default: 0.5
        self.time_move = 0.04 # minimum time interval to move | Default: 0.05
        self.time_rotate = 0.13 # minimum time interval to rotate | Default: 0.2
        ...
        # shapes, dont touch this if you are not clear what this does
        self.shapes = (
